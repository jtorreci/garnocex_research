...
> [Authors anonymized for peer review] (2026). *A Probabilistic Framework
...
and the software. Citation entries are anonymized below for peer review
and will be filled in upon acceptance:
...
@software{voronoi_risk_toolbox,
  ...
  year    = {2026},
  url     = {https://anonymous.4open.science/r/garnocex_research-5FF2},
  version = {0.2.0}
}
```
...
Funding and institutional acknowledgements have been anonymized for
